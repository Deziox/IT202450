        ...
        try{
            ...
            if(!$surveys){
                ...
                foreach($surveys as $s) {
                    ...
                    echo '<tr><th><h4 class="top">top: </h4></th></tr><tr style="border:5px solid dodgerblue">';
                    ...
                    echo '</tr>';
                    echo '<tr><th><h4 class="bottom">bottom: </h4></th></tr><tr style="border:5px solid dodgerblue">';
