        ...
        try{
            ...
            if(!$surveys){
                ...
                foreach($surveys as $s) {
                    ...
                    echo '<tr>';
                    echo '<th><h4 class="top">top: </h4><img class="clothes" src="data:image/png;base64,' . base64_encode($s['top_1_image']) . '"/></th>';
                    echo '<th><img class="clothes" src="data:image/png;base64,' . base64_encode($s['top_2_image']) . '"/></th>';
                    echo '</tr>';
                    echo '<tr>';
                    echo '<th><h4 class="bottom">bottom: </h4><img class="clothes" src="data:image/png;base64,' . base64_encode($s['bottom_1_image']) . '"/></th>';
