        ...
        try{
            ...
            if(!$surveys){
                ...
                foreach($surveys as $s) {
                    ...
                    echo '<th><img class="clothes" src="images/' . $s['top_1_image'] . '"/></th>';
                    echo '<th><img class="clothes" src="images/' . $s['top_2_image'] . '"/></th>';
                    ...
                    echo '<th><img class="clothes" src="images/' . $s['bottom_1_image'] . '"/></th>';
                    echo '<th><img class="clothes" src="images/' . $s['bottom_2_image'] . '"/></th>';
