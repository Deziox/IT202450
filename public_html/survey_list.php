        ...
        try{
            ...
            if(!$surveys){
                ...
                foreach($surveys as $s) {
                    ...
                    echo '<th><img class="clothes" src="upload/' . $s['top_1_image'] . '"/></th>';
                    echo '<th><img class="clothes" src="upload/' . $s['top_2_image'] . '"/></th>';
                    ...
                    echo '<th><img class="clothes" src="upload/' . $s['bottom_1_image'] . '"/></th>';
                    echo '<th><img class="clothes" src="upload/' . $s['bottom_2_image'] . '"/></th>';
